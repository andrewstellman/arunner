...
Repo: `/Users/andrewstellman/Documents/arunner`. Suite: `python3 -m pytest`.
...
- **Docs only:** `README.md`, `TOOLKIT.md`, `plugins/arunner/skills/arunner/SKILL.md` (diff is purely additive — `+81` lines, no deletions, no engine edits).
...
arunner repo. (`__pycache__` regenerated by pytest is incidental and untracked.)
